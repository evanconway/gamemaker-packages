...
if (selected_time >= 0) {
	if (--selected_time <= 0) {
		...
		if (using_mouse) text_button_list_set_highlighted_at_xy_horizontal(list, _x, _y, _mx, _my, _alignment);
	}
	
} else if (using_mouse) {
	text_button_list_set_highlighted_at_xy_horizontal(list, _x, _y, _mx, _my, _alignment);
	if (mouse_check_button_pressed(mb_left)) {
		var _clicked_option_index = text_button_list_get_option_at_xy_horizontal(list, _x, _y, _mx, _my, _alignment);
...
text_button_list_draw_horizontal(list, _x, _y, _alignment);
