var _updating = keyboard_check(ord("U"));
var _drawing = keyboard_check(ord("D"));
...
if (_updating) tag_decorated_text_update(test);
if (_drawing) tag_decorated_text_draw_no_update(test, 40, 40);
